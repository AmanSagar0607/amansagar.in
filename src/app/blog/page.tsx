...
export const metadata: Metadata = {
  title: "Blog",
  description: "A blog on AI agents, context engineering, product thinking, and building useful software.",
};
    ...
    <main className="page-shell">
      <section className="page-section">
        <PageHeader
          eyebrow="Blog"
          title="blog."
          description="Notes on AI systems, product engineering, and the practical lessons that come from building real software."
