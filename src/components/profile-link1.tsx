...
export const ProfileLinks = () => {
  return (
    <div className="flex flex-col items-start border-neutral-100 pt-6 dark:border-neutral-800 sm:flex-row sm:items-center">
      {/* Profile Links */}
      <div className="flex items-center gap-4">
        {/* mail */}
        <Link href="mailto:amansagar0307@gmail.com">
        ...
        {/* Behance */}
        <Link href="https://behance.net/amansagar0607">
        ...
        {/* Hire Me - Hidden on mobile, shown inline on larger screens */}
        <Link
          href="https://calendly.com/amansagar0307/30min"
          className="group relative ml-2 hidden items-center gap-2 rounded-full bg-neutral-200 px-4 py-1.5 pr-4 pl-3 text-sm font-medium text-primary dark:text-neutral-100 transition-colors hover:bg-neutral-300 dark:bg-neutral-700  dark:hover:bg-neutral-600 sm:flex"
        >
          <span className="relative flex h-2 w-2">
            <span className="absolute inline-flex h-full w-full animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite] rounded-full bg-emerald-600 opacity-75"></span>
      ...
      {/* Hire Me - Shown below social links on mobile */}
      <Link
        href="https://calendly.com/amansagar0307/30min"
        className="group relative mt-4 flex items-center gap-2 rounded-full bg-neutral-200 px-4 py-1.5 pr-4 pl-3 text-sm font-medium text-primary dark:text-neutral-100 transition-colors hover:bg-neutral-300 dark:bg-neutral-700  dark:hover:bg-neutral-600 sm:hidden"
      >
        <span className="relative flex h-2 w-2">
          <span className="absolute inline-flex h-full w-full animate-[ping_3s_cubic-bezier(0,0,0.2,1)_infinite] rounded-full bg-emerald-600 opacity-75"></span>
          <span className="relative inline-flex h-2 w-2 rounded-full bg-emerald-500"></span>
